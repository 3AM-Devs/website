...
const Hero: React.FC = () => {
  ...
  const colors = ["#10B774", "#10B774", "#10B774"];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
    ...
    <div className="relative min-h-screen flex items-center py-16">
      ...
      <Container className="relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto relative">
          {/* World globe positioned behind text content */}
          <div className="absolute inset-0 -z-10 opacity-50 flex items-center justify-center">
            <div className="w-full h-full scale-[1.12] md:scale-125 lg:scale-155 flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mt-8 animate-fadeIn delay-200">
            ...
            <div className="flex flex-col items-center p-6 bg-card rounded-lg border border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground text-center">
                Join virtual and in-person community events and collaboration
                sessions.
              </p>
            </div>
